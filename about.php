...
<h4>Release</h4>
<p><span class='project'>lpStore</span> was introduced to the communitiy on April 29<sup>th</sup>, 2013, and it's source code can be viewed on <a href='https://github.com/blitzmann/lpStore' target='_blank'>GitHub</a>.</p>
<h3>lpDatabase</h3> 
...
<h3>emdr-py</h3>
<p><span class='project'>emdr-py</span> is an open-source EMDR consumer script written in Python and using a Redis key-value storage backend. Initially based off of Steve Ronuken's <a href='https://github.com/fuzzysteve/EMDR-Consumer' target='_blank'>Perl script</a> (credit should go to him for how the prices are calculated). It is a set-it-and-forget-it consumer, constantly pulling data from the EMDR services for the most up-to-date prices available.</p>
<h4>Release</h4>
<p><span class='project'>emdr-py</span> is released on <a href= 'https://github.com/blitzmann/emdr-py' target='_blank'>GitHub</a>.</p>
<h3>Credits</h3>
<dl>
    <dt>Steve Ronuken</dt>
